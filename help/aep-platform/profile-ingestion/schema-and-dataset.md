...
Weitere Informationen finden Sie in [dieser Dokumentation](https://www.adobe.io/apis/experienceplatform/home/xdm/xdmservices.html#!api-specification/markdown/narrative/technical_overview/schema_registry/schema_composition/schema_composition.md) .

### Erstellen eines Schemas

Partner können ein Schema mithilfe der Benutzeroberfläche erstellen, indem sie diesem [Tutorial](https://docs.adobe.com/content/help/en/experience-platform/xdm/tutorials/create-schema-ui.html) folgen. In diesem Beispiel wird das Profil-Schema des Treueprogramms verwendet. Während das Beispiel ein Profilschema ist, können ereignisbasierte Schemas mit einem ähnlichen Prozess verwendet werden.

Um die APIs verwenden zu können, müssen Partner über eine vorhandene Adobe I/O-Integration mit [!DNL Experience Platform] -Berechtigungen verfügen. Weitere Informationen finden Sie in diesem Handbuch zum Erstellen einer I/O-Integration ](https://docs.adobe.com/content/help/de-DE/experience-platform/tutorials/home.html#!api-specification/markdown/narrative/tutorials/authenticate_to_acp_tutorial/authenticate_to_acp_tutorial.md).[

Rufen Sie dann [diesen Link](https://docs.adobe.com/content/help/en/experience-platform/xdm/tutorials/create-schema-api.html) auf, um zu erfahren, wie Sie Schemas mithilfe der API erstellen.
...
Alle Daten, die in Adobe [!DNL Experience Platform] eingegeben werden, sind in Datensätzen enthalten. Ein Datensatz ist ein Konstrukt zur Datenspeicherung und -verwaltung, in dem Daten (in der Regel) in einer Tabelle erfasst werden, die ein Schema (Spalten) und Felder (Zeilen) beinhaltet. Datensätze enthalten auch Metadaten, die verschiedene Aspekte der in ihnen gespeicherten Daten beschreiben.
...
Eine detaillierte Datensatzübersicht finden Sie unter [hier](https://docs.adobe.com/content/help/en/experience-platform/catalog/datasets/overview.html) .

### Erstellen eines Datensatzes

![Erstellen eines Datensatzes mit animiertem GIF](images/creating_a_dataset.gif)
...
1. Klicken Sie auf **[!UICONTROL Aus Schema erstellen]**.

1. Klicken Sie auf **[!UICONTROL Fertigstellen]**.

Rufen Sie [hier](https://docs.adobe.com/content/help/en/experience-platform/catalog/datasets/user-guide.html) ein Benutzerhandbuch zu Datensätzen auf.

[Erstellen Sie einen Datensatz mit den APIs](https://docs.adobe.com/content/help/en/experience-platform/catalog/datasets/create.html).
