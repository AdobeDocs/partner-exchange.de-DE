...
user-guide-description: Adobe Exchange-Integrationshandbücher
...
+ {#profile-ingestion} zur Datenaufnahme und zum Profilzugriff
   ...
   + [Importieren von Echtzeitdaten](profile-ingestion/real-time-import.md)
   + [Zugreifen auf das einheitliche Profil](profile-ingestion/query-profile.md)
